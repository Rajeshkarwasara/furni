...
<body>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $count_leanth = count($_SESSION['product']);
                  ...
                  <tr>
                    ...
                    <td class="product-name">
                      <h2 class="h5 text-black">
                        <?php echo $_SESSION["product"][$i]["product_name"]; ?>
                      </h2>
                    </td>
                    <td>$
                      <?php echo $_SESSION["product"][$i]["product_pric"]; ?>
                    </td>
                    <td>
                      <div class="input-group mb-3 d-flex align-items-center quantity-container"
                        ...
                        <input type="text" class="form-control text-center quantity-amount" value="<?php echo $_SESSION["quantity".$_SESSION["product"][$i]['product_id']]; ?>" placeholder=""
                    ...
                    <td>$<?php echo($_SESSION["quantity".$_SESSION["product"][$i]['product_id']]*$_SESSION["product"][$i]['product_pric']); ?></td>
        ...
        <div class="col-md-6 pl-5">
          <div class="row justify-content-end">
            <div class="col-md-7">
              ...
              <div class="row">
                <div class="col-md-12">
                  <button class="btn btn-black btn-lg py-3 btn-block" onclick="window.location='checkout.php'">Proceed
                    To Checkout</button>
                </div>
              </div>
            </div>
